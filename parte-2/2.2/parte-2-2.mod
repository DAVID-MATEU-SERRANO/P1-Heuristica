...
var y {i in SLOTS, k1 in BUSES, k2 in BUSES: k2 > k1} binary;
...
s.t. AND_1 {i in SLOTS, k1 in BUSES, k2 in BUSES: k2 > k1}: y[i,k1,k2] <= sum {j in WORKSHOPS} x[i,j,k1];
s.t. AND_2 {i in SLOTS, k1 in BUSES, k2 in BUSES: k2 > k1}: y[i,k1,k2] <= sum {j in WORKSHOPS} x[i,j,k2];
s.t. AND_3 {i in SLOTS, k1 in BUSES, k2 in BUSES: k2 > k1}: y[i,k1,k2] >= (sum {j in WORKSHOPS} (x[i,j,k1] + x[i,j,k2])) - 1;
